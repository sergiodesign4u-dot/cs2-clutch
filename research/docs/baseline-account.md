...
2. **`B7-1` is not a perception problem here, it is the product.** The barrier reads: the gap between what a win appears to be worth and what it is worth. On this screen that gap is a number, printed by the product itself, and it is **six times** the value of the win in the observed row.

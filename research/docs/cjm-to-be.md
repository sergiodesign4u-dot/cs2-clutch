...
Thirty eight MVP rows, thirty seven distinct capabilities: A4 and G3 are one feature on two surfaces. Seven of the rows are rules or architecture rather than something anyone draws. The counts moved from thirty seven and thirty six on 11 August 2026, when the founder returned the daily free case to round 1 as I2.

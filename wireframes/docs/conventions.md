...
| **The content column is capped** | `--wf-content: 1220px`, app `1440px` | 1440px is the width `baseline.md` walked and the width `home.md` section 7 computes its third-column argument at. Uncapped, the argument blocks ran 1900px wide on the founder's own monitor |

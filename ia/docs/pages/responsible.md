...
|---|---|---|
| `responsible.html` | No boundary in force | `6.1` |
| `responsible-guest.html` | Guest, no account | `6.1` |
| `responsible-confirm.html` | Self exclusion confirmation | `6.2` |
| `responsible-in-force.html` | Boundary in force | `6.3` |
| `responsible-excluded.html` | Self excluded | `6.3` |
